...
class TextRecognizer():
    def __init__(self):
        ...
        self.ort_session = onnxruntime.InferenceSession("/home/thien/Desktop/ParkingManagement/plate/models/ocr_rec.onnx",providers=['CUDAExecutionProvider','TensorrtExecutionProvider', 'CPUExecutionProvider']) #providers=['CUDAExecutionProvider','TensorrtExecutionProvider', 'CPUExecutionProvider']
