...
class Ui_MainWindow(object):
    def __init__(self,StaffName = None):
        ...
        self.CustomersCollection = DataBase["Parking"]
    ...
    def SetDefault(self):
        ...
        self.LicensePlateValueLabel.setText("")
    ...
    def VideoLicencePlateStream(self):
        ...
        if self.Checklp == self.LicensePlate:
            ...
            self.Lp = self.LicensePlate
            self.Checklp = self.LicensePlate

        print("license =",self.LicensePlate)
        print('lp',self.Lp)
    ...
    def CheckLicencePlate(self):
        state = False
        if self.Lp != None and self.Lp != "":
            for CustomersDocument in self.CustomersCollection.find():
                if self.Lp == CustomersDocument["License Plate"]:
                    self.LicensePlateValueLabel.setText("Exist")
                    return 0

            for CustomerDB in self.CustomerDBcollection.find():
                if self.Lp == CustomerDB["License Plate"]:
                    state = True

            if state:
                self.LicensePlateValueLabel.setText("{}".format(self.Lp))
                self.GetFace()
            else:
    ...
    def Pay(self):
        ...
        self.TotalTimeValueLabel.setText("{}".format(time.ctime(Customer['TimeIN'])))
        ...
        self.HistoryCollection.insert_one(
            {"License Plate": Customer["License Plate"], "TimeIN": Customer["TimeIN"],
             "TimeOUT": now, "TotalTime": str(time_del),"StaffName":Customer["StaffName"]})
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LicensePlateValueLabel.setText(_translate("MainWindow", ""))
        ...
        self.TotalTimeLabel.setText(_translate("MainWindow", "Time In"))
