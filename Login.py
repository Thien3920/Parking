...
class UiLoginWindow(object):
    ...
    def OpenMainWindow(self):
        ...
        self.MainWindowUi = MainWindow.Ui_MainWindow(StaffName=self.StaffDocument['Name'])
    ...
    def CheckAccount(self):
        ...
        if self.CheckEnterUsername():
            ...
            if self.UserNameState == None:
                for self.StaffDocument in self.StaffCollection.find():
                    if self.Username == self.StaffDocument['UserName']:
            ...
            if self.CheckEnterPassWord():
                ...
                elif (self.UserNameState == "User") and (self.PassWord == self.StaffDocument["PassWord"]):
