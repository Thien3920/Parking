...
class Ui_MainWindow(object):
    def __init__(self):
        ...
        self.CustomerCollection = DataBase["Customer"]
    def Back(self):
...
"}")
    ...
    def Save(self):
        ...
        if self.license != "" and self.license != None:
            for Customer in self.CustomerCollection.find():
                if self.license == Customer["License Plate"]:
            ...
            if len(self.files[0]) > 0:
                ...
                self.CustomerCollection.insert_one({"License Plate":self.license,"Code":codes,"Images":Images})
